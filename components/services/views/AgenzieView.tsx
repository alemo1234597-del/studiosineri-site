                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <FeatureCard
                            ...
                            className="hover:border-red-500/30 hover:shadow-[0_0_30px_-10px_rgba(239,68,68,0.15)] group-hover:text-red-500" // Custom overrides if needed, but FeatureCard handles most
                        />
                        <FeatureCard
                            icon={Hourglass}
            ...
            <section id="contact" className="py-32 relative bg-gradient-to-b from-[#020412] to-[#0f172a]">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto glass-panel rounded-3xl p-8 md:p-12 border-t border-white/20 shadow-[0_0_40px_-10px_rgba(255,90,54,0.3)] bg-[#1e293b]/20">
                        ...
                        <form className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                            <div className="col-span-2 md:col-span-1">
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Nome Completo</label>
                                <input className="w-full bg-[#020412] border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Mario Rossi" type="text" />
                            </div>
                            <div className="col-span-2 md:col-span-1">
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Nome Agenzia</label>
                                <input className="w-full bg-[#020412] border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Immobiliare Top" type="text" />
                            </div>
                            <div className="col-span-2">
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Email Aziendale</label>
                                <input className="w-full bg-[#020412] border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="mario@immobiliaretop.it" type="email" />
                            </div>
                            <div className="col-span-2">
                                <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Città Operativa</label>
                                <input className="w-full bg-[#020412] border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Milano" type="text" />
                            </div>
                            <div className="col-span-2 pt-4">
                                <PrimaryButton className="w-full h-14 text-lg justify-center shadow-lg hover:shadow-primary/40">
